...
function InvoiceTableServices() {
    ...
    const fetchInvoices = async (selectedCenter) => {
        ...
        setIsLoading(true);
        try {
            const response = await fetch(`http://localhost:8000/invoices/services?center=${selectedCenter}&from_date=${fromDate}&to_date=${toDate}`);
...
export default InvoiceTableServices;